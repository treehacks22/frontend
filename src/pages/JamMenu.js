...
function JamMenu() {
    return (
        <div style={{ padding: '30px', height: '100vh', backgroundRepeat: 'no-repeat', backgroundColor: "black", backgroundSize: 'cover',  backgroundPosition: 'center', textAlign: 'center'}}>
            ...
            <nav style={{marginBottom: '-50px'}}>
                <Button variant="outlined" size = 'large' component={Link} to="/jam" style={{maxWidth: '150px', maxHeight: '150px', minWidth: '150px', minHeight: '150px', margin: '50px', fontFamily: 'GuitarHero', color: '#BE4FF3', fontSize: '40px'}}>Jam</Button>
            </nav>
        </div>
    );
  }
